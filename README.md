# Full Stack MERN Next.js 13 Threads App Clone | React, Next JS, TypeScript, MongoDB
...
<a  href="https://www.youtube.com/watch?v=O5cmLDVTgAs&ab_channel=JavaScriptMastery"  target="_blank"><img  src="https://github.com/sujatagunale/EasyRead/assets/151519281/1736fca5-a031-4854-8c09-bc110e3bc16d"  /></a>

You can also find their original repository [here](https://github.com/adrianhajdin/threads).
  

## <a name="introduction">🤖 Introduction</a>

This is a a full stack Threads clone using Next.js 14+ with a redesigned look transformed from a Figma design, user interaction to community management, technical implementation, and various features, including nested deep comments, notifications, real-time-search, and more.
...
```bash
git clone https://github.com/MathildeMnrt/threads_clone.git
cd threads
```
